...
<div class="topnav" id="myTopnav">
    <a href="/" style="padding: 0"><img src="/img/logo.png" alt="Genshin Optimizer" width="54" height="54"></a>
    <a href="/characters">Personnages</a>
    <a href="/weapons">Armes</a>
    <a href="/artifacts">Artéfacts</a>
    <a href="/optimizer">
    ...
    -->
    <?php if (!array_key_exists('user', $_SESSION) || !$_SESSION['user'] instanceof Users) { ?>
        <a href="/authentication/registration" style="float: right">Inscription</a>
        <a href="/authentication" style="float: right">Connexion</a>
    <?php } else { ?>
        <a href="/authentication/disconnect" style="float: right">
